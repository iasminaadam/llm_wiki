# Programul de studii universitare de master Sisteme și Control Automat/Systems and Control (SC)
...
- Dezvoltarea de aplicaţii complexe software pentru implementarea unor algoritmi şi structuri de control utilizând medii de programare, tehnici de inteligență artificială și tehnologii avansate (sisteme bazate pe microcontrolere, procesoare de semnal, automate programabile).
