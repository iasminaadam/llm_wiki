...
[Extrasele fișelor de disciplină pentru disciplinele studiate în cadrul domeniului Calculatoare și tehnologia informației](https://ac.tuiasi.ro/extrasele-fiselor-de-disciplina-pentru-disciplinele-studiate-in-cadrul-domeniului-calculatoare-si-tehnologia-informatiei/)
...
|---|
| Calculatoare încorporate | Internet of Things |
| Tehnici de procesare digitală a semnalelor | Vedere artificială |
| Securitatea spațiului cibernetic | Fiabilitate și siguranța în funcționare |
| Cercetare științifică și practică (sem.1) | Circuite digitale autotestabile |
| Tehnici avansate de învățare automată | Cercetare științifică și practică (sem.2) |
| Programare GPU | Etică și integritate |
...
| Semestrul I | Semestrul al II-lea |
|---|
| Rețele de calculatoare încorporate | Proiect multidisciplinar |
